            ...
            return t = GoCart, r = [{
                ...
                value: function (t) {
                    ...
                    this.clearCartDrawer(), t.items.forEach((function (t, r) {
                        let a = t.variant_title,
                        line = Number(r + 1),
                        title = t.product_title,
                        image = t.image,
                        url = t.url,
                        price = formatMoney(t.line_price, e.moneyFormat),
                        labelQuantity = e.labelQuantity,
                        quantity = t.quantity,
                        removeFromCartNoDot = e.removeFromCartNoDot,
                        labelRemove = e.labelRemove;
                        null === a && (a = "");
                        var o = `<div class="go-cart-item__single" data-line="${line}">
                        <div class="go-cart-item__info-wrapper">
                            <div class="go-cart-item__image" style="background-image: url('${image}');">
                            </div>
                            <div class="go-cart-item__info"> <a href="${url}" class="go-cart-item__title">${title}</a>
                                <div class="go-cart-item__variant">
                                    ${a}
                                </div>
                                <div class="go-cart-item__price">${price}</div>
                                <div class="go-cart-item__quantity">
                                    <span class="go-cart-item__quantity-label">${labelQuantity}</span>
                                    <span class="go-cart-item__quantity-button js-go-cart-quantity-minus"> - </span>
                                    <input class="go-cart-item__quantity-number js-go-cart-quantity" type="number" value="${quantity}"
                                        disabled>
                                    <span class="go-cart-item__quantity-button js-go-cart-quantity-plus">+</span>
                                </div>
                                <a class="go-cart-item__remove ${removeFromCartNoDot}"> ${labelRemove} </a>
                            </div>
                        </div>
                    </div>`;
                        ...
                        t.addEventListener("click", (function () {
                            ...
                            var r = t.parentNode.parentNode.parentNode.getAttribute("data-line");
                            e.removeItem(r)
                        }))
